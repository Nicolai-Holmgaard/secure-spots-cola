  ...
  internal = rec {
    ...
    crates = {
      ...
      "confy" = rec {
        ...
        version = "2.0.0";
        edition = "2024";
        sha256 = "0528xqlri0kwjlzjlyv910l1712m6igyl9qsvfxh5glwg2bw61w8";
        authors = [
